...
if [ -n "$X86_32" ]; then
sudo apt-get install --fix-missing --force-yes ocaml-nox:i386 ocaml-native-compilers:i386 camlp4-extra:i386 opam:i386 opam-docs:i386 gcc:i386 binutils:i386 cpp:i386 gcc-4.6:i386
else
